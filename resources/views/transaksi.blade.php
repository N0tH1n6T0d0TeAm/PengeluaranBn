...
<script>
 ...
 var tr = '<tr><td class="no">' + numberofrow + '</td>' +
     ...
     '<td> <input type="number" name="harga[]" class="form-control harga" id="harga"></td>' +
     '<td> <input type="number" name="kwantitas[]"  class="form-control kwantitas" id="kwantitas_t"></td>' +
     '<td> <input type="text" name="satuan[]" class="form-control satuan" id="satuan"></td>' +
     '<td> <input type="number" name="diskon[]" class="form-control diskon" id="diskon"></td>' +
     '<td> <input type="number"  name="total[]"  class="form-control totalAmount" id="totalAmount"></td>' +
